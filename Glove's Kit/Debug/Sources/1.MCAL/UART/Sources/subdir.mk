...
C_SRCS += \
../Sources/1.MCAL/UART/Sources/UART.c 

OBJS += \
./Sources/1.MCAL/UART/Sources/UART.o 

C_DEPS += \
./Sources/1.MCAL/UART/Sources/UART.d 


# Each subdirectory must supply rules for building sources it contributes
Sources/1.MCAL/UART/Sources/%.o: ../Sources/1.MCAL/UART/Sources/%.c
	@echo 'Building file: $<'
