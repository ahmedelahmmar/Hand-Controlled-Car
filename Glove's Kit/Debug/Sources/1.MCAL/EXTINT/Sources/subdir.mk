...
C_SRCS += \
../Sources/1.MCAL/EXTINT/Sources/EXTINT.c 

OBJS += \
./Sources/1.MCAL/EXTINT/Sources/EXTINT.o 

C_DEPS += \
./Sources/1.MCAL/EXTINT/Sources/EXTINT.d 


# Each subdirectory must supply rules for building sources it contributes
Sources/1.MCAL/EXTINT/Sources/%.o: ../Sources/1.MCAL/EXTINT/Sources/%.c
	@echo 'Building file: $<'
